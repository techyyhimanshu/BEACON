...
const {addBeacon, login, updateBeacon, getAllBeacons, getSingleBeacon, getBeaconsList, getDevicesOfBeacons }= require('../controllers/beaconController')
...
router.post("/api/beacon/devices/list",getDevicesOfBeacons)
